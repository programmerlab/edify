...
class CreateOrdersTable extends Migration {
	...
	public function up()
	{
		Schema::create('orders', function(Blueprint $table)
		{
			...
			$table->string('editor_status')->nullable();
			$table->string('customer_original_image', 1024)->nullable();
			$table->string('customer_reference_image', 1024)->nullable();
			$table->string('editor_after_work_image', 1024)->nullable();
			...
			$table->text('editor_remarks', 65535)->nullable();
