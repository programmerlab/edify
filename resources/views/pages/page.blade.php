...
<section class="slider">
    ...
    <section class="about">
        <div class="aboutbox">
            <div class="">
                <div class="abouttxt" style="width: 100%">
                    <h2 class="sectiontitle">{{$content->title??'Page Not Found' }} </h2>
...
"></div>
      ...
      <section class="grids">
        <div class="container">
            ...
            <div class="flexi">
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/1.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/2.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/3.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/4.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/5.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/6.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/7.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/8.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/9.jpg')}}" alt="">
                </div>
                <div class="items">
                    <img width="220" height="250" border="0" align="center" src="{{url('assets/img/sample_work/final_10.jpg')}}" alt="">
                </div>
            </div>
        </div>
    </section>
