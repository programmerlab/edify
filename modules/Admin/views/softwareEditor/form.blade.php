 <div class="form-body">
    <div class="alert alert-danger display-hide">
 	...
 	<div class="form-group {{ $errors->first('software_name', ' has-error') }}  @if(session('field_errors')) {{ 'has-error' }} @endif">
        <label class="control-label col-md-3"> Software editor Name <span class="required"> * </span></label>
        <div class="col-md-4"> 
            {!! Form::text('software_name',null, ['class' => 'form-control','data-required'=>1])  !!} 
            
            <span class="help-block" style="color:red">{{ $errors->first('software_name', ':message') }} @if(session('field_errors')) {{ 'The Software name already been taken!' }} @endif</span>
        </div>
    </div>  
