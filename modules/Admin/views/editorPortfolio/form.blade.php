...
<div class="form-group  {{ $errors->first('image_name', ' has-error') }}">
    ...
    <div class="form-group {{ $errors->first('category_name', 'has-error') }}">
            ...
            <div class="col-md-4">  
               {{ Form::select('category_name',$category_name, $editorPortfolio->category_name, ['class' => 'form-control']) }}
    ...
    <div class="form-group {{ $errors->first('software_editor', 'has-error') }}">
            ...
            <div class="col-md-4">  
               {{ Form::select('software_editor',$software_editor, $editorPortfolio->software_editor, ['class' => 'form-control']) }}
